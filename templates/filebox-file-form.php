<form id="file-form" action="" method="post" class="filebox-file-form filebox-iframe-form">
	...
	<p>
		...
		<input id="file-name" type="text" class="file-name" name="file_name" value="<?php echo esc_attr( $file->post_title ); ?>" />
	</p>

	<p>
		<label for="file-desc" class="file-desc"><?php _e( 'File description', 'filebox' ); ?></label><br/>
		<input id="file-desc" type="text" class="file-desc" name="file_description" value="<?php echo esc_attr( $file->post_excerpt ); ?>" />
	</p>
