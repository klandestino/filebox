<form id="folder-form" action="" method="post" class="filebox-folder-form">
	...
	<input type="hidden" name="action" value="filebox_add_folder" />
	...
	<p>
		...
		<input id="folder-name" type="text" class="folder-name" name="folder_name" value="<?php echo is_object( $folder ) ? esc_attr( $folder->name ) : ''; ?>" />
	</p>

	<p>
		<label for="folder-desc" class="folder-desc"><?php _e( 'Folder description', 'filebox' ); ?></label><br/>
		<input id="folder-desc" type="text" class="folder-desc" name="folder_description" value="<?php echo is_object( $folder ) ? esc_attr( $folder->description ) : ''; ?>" />
	</p>
